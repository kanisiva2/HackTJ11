...
class OnboardingSlideWidget extends StatefulWidget {
  const OnboardingSlideWidget({super.key});
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Image.network(
                                        'https://images.unsplash.com/photo-1606787366850-de6330128bfc?crop=entropy&cs=srgb&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw4fHxmb29kfGVufDB8fHx8MTcwODc4NTcxNHww&ixlib=rb-4.0.3&q=85',
                                        height: 250.0,
                                        fit: BoxFit.contain,
                                      ).animateOnPageLoad(animationsMap[
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 48.0, 0.0, 0.0),
                                        child: Text(
                                          'Elevate your dining experience with RecipeRadar, your personalized recipe concierge, crafting delicious dishes based on your dietary preferences',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge,
                                        ).animateOnPageLoad(animationsMap[
